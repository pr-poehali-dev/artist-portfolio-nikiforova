          ...
          <CardContent className="p-8 md:p-12">
            ...
            <div className="space-y-4 text-lg text-foreground/80">
              <p>
                ...
                Я художник, который рисует в стиле аниме.
              </p>
              <p>
                Родилась в <span className="font-semibold">Санкт-Петербурге</span> — городе, где культура и искусство
                переплетаются с каждым шагом. Сейчас учусь на технической специальности,
                но творчество всегда было моим способом найти гармонию и спокойствие.
              </p>
              <p>
                Рисование для меня — это не просто хобби, это способ выразить эмоции
                и создать свой уникальный мир. Аниме-стиль привлекает меня своей
                выразительностью, яркими образами и возможностью воплотить любые фантазии.
              </p>
